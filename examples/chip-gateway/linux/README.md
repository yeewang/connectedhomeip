# CHIP Linux Gateway Example

An example showing the use of CHIP on the Linux. The document will describe how
to build and run CHIP Linux Gateway Example on Raspberry Pi. This doc is tested
on **Ubuntu for Raspberry Pi Server 20.04 LTS (aarch64)** and **Ubuntu for
Raspberry Pi Desktop 20.10 (aarch64)**

<hr>

-   [CHIP Linux Gateway Example](#chip-linux-gateway-example)
    -   [Building](#building)
...
-   Build the example application:
          ...
          $ cd ~/connectedhomeip/examples/chip-gateway/linux
